...
<head>
    ...
    <title>Upload Danh Sách Điểm Tuần CDSV</title>
...
<body>
    <div class="main">
        ...
        <div class="main_body grid wide">
            ...
            Chọn file danh sách điểm tuần CDSV của sinh viên lớp <?= $class_name ?>
            </h5>
            ...
            <form action="upload_citizen_student_excel.php" method="POST" enctype="multipart/form-data" style="border: 2px solid;width: 600px;margin: 10px auto 20px;border-radius: 8px;padding: 20px 20px;box-shadow: 0 5px 2px -3px;">
                <?php
            ...
            <table id="show_point_citizen" class="table table-striped table-bordered">
