...
<head>
    ...
    <link rel="stylesheet" href=<?php echo $path."assets/css/base.css"?>>
    <link rel="stylesheet" href=<?php echo $path."assets/css/base_1.css"?>>
    <link rel="stylesheet" href=<?php echo $path."assets/css/footer.css"?>>
    <link rel="stylesheet" href=<?php echo $path."assets/css/khoaCss.css"?>>
