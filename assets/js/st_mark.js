...
let sum_item = document.querySelectorAll('.sum_item')
console.log([sum_item[0].readOnly])
for(let i = 0; i < sum_item.length; i++) {
    sum_item[i].readOnly = true
}