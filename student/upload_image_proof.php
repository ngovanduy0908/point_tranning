...
<body>
    <div class="main">
        ...
        <div class="main_body grid wide">
            ...
            <h3 class="text-center"><?= $_SESSION['user']['name'] ?></h3>
            <h4 class="text-center">Chọn minh chứng</h4>
            <form action="" method="post" enctype="multipart/form-data" style="border: 2px solid;width: 600px;margin: 10px auto 30px;border-radius: 8px;padding: 20px 20px;box-shadow: 0 5px 2px -3px;">
        ...
        if($sql_get_proof_img_run-> num_rows >0 ){
            while($sql_get_proof_img_item = $sql_get_proof_img_run->fetch_assoc()){
                ...
                <div style="justify-content: center;display: flex">
                    ...
                    <a href="ajax_delete_proof.php?id=<?=$sql_get_proof_img_item['id']?>" class="btn btn-danger ml-2" style="height: 40px;">Xóa</a>
                </div>
            <?php
            }
        }
