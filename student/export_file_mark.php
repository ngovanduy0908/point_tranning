...
if (isset($_POST['export_btn'])) {
    ...
    // var_dump($sql_student_point_run);
    // exit;
    if (mysqli_num_rows($sql_student_point_run) > 0) {
        ...
        echo "Không có dữ liệu" . "<a href='selection.php'>Quay lại</a>";
        // echo $connect->error;
